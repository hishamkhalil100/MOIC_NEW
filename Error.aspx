...
<body>
    ...
    <div>
        <h1>
            <img src="assets/layouts/layout2/img/head1.png" class="img1" />
        </h1>
        <h2>
            <img id="imgError" runat="server" src="assets/layouts/layout2/img/errorLayer.png" class="img2" /></h2>
        <h2>
            <a href="http://www.kfnl.gov.sa">
                <img src="assets/layouts/layout2/img/Layer 4.png" class="img3" /></a>
        </h2>
    </div>
    <!--[if lt IE 9]>
