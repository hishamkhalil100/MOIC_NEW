<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Printed.aspx.cs" Inherits="Printed" %>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtAuthName" type="text" runat="server" required="required" class="form-control  " name="authname" readonly="" maxlength="254" />
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtBookTitle" runat="server" type="text" class="form-control" name="booktitle" readonly="" required="required" maxlength="254" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtPubName" type="text" runat="server" class="form-control" name="pubname" readonly="" required="required" maxlength="254" />
