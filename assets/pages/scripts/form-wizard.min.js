        ...
        init: function () {
            ...
            if (jQuery().bootstrapWizard) {
                ...
                $("#countries_list").select2({
                    placeholder: ArabicReshaper.convertArabic($("#chocee")["0"].title),
                    allowClear: !0,
                    formatResult: e,
                    width: "auto",
                    formatSelection: e,
                ...
                $("#gerg").select2({
                    placeholder: $.trim(ArabicReshaper.convertArabic($("#chocee")["0"].title)),
                    allowClear: !0,
                    formatResult: e,
                    width: "auto",
                    formatSelection: e,
                ...
                var a = function () {
                    ...
                    o = function (e, r, t) {
                        var i = r.find("li").length,
                            o = t + 1;
                        $(".step-title", $("#form_wizard_1")).text(ArabicReshaper.convertArabic($("#step")["0"].title) + (t + 1) + " " + ArabicReshaper.convertArabic($("#to")["0"].title) + i), jQuery("li", $("#form_wizard_1")).removeClass("done");
