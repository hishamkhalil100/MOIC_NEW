                        ...
                        <div class="portlet light " id="form_wizard_1">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red bold uppercase">نموذج طلب تسجيل مادة فنية	
 -
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtTitle" runat="server" type="text" class="form-control" name="booktitle" required="required" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtArtist" type="text" runat="server" class="form-control" name="pubname" required="required" />
                                                            <span class="help-block">الرجاء ادخال اسم الفنان الاول  </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtArtist1" type="text" runat="server" class="form-control" name="pubname"  />
                                                        </div>
                                                    </div>
                                                      <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtArtist2" type="text" runat="server" class="form-control" name="pubname"  />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <span class="help-block">الرجاء اختيار نوع العمل  </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">    
                                                        <label class="control-label col-md-3">
                                                           شكل العمل و المواد المستخدمة 
                                                        </label>
                                                        <div class="col-md-4">
                                                            <input id="txtMaterial" type="text" runat="server" class="form-control" name="txtMaterial"  />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDimentions" runat="server" type="text" class="form-control" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtepisodeNo" runat="server" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div id="filesUpload">
                                                        <div class="form-group">
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepPhone" runat="server" type="text" class="form-control" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepFax" runat="server" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepPost" runat="server" type="text" class="form-control" />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepZip" runat="server" type="text" class="form-control" />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtDepNID" runat="server" type="text" class="form-control" name="card_number" required="required" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtDepName" runat="server" type="text" placeholder="" class="form-control" required="required" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtDepEmail" runat="server" type="email" placeholder="" class="form-control" required="required" />
                                                            <span class="help-block">*</span>
