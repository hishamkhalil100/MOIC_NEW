<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Periodical.aspx.cs" Inherits="Periodical" %>
                        ...
                        <div class="portlet light " id="form_wizard_1">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red bold uppercase">نموذج طلب تسجيل مادة دورية 	
 -
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtTitleAr" runat="server" type="text" class="form-control" name="booktitle" required="required" maxlength="255"/>
                                                            <span class="help-block">الرجاء ادخال عنوان العمل </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                            عنوان العمل بالأنجليزية
                                                               <span class="required">* </span>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <input id="txtTitleEn" runat="server" type="text" class="form-control" name="booktitle" required="required" maxlength="255"/>
															<span class="help-block">الرجاء إدخال عنوان العمل باللغة الانجليزية </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtISSN" type="text" runat="server" class="form-control" name="pubname" maxlength="255"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtPubName" runat="server" type="text" class="form-control" name="pubname" required="required" maxlength="255"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="pubCity" id="typeID" runat="server" class="form-control" required="required" >
                                                            </select>
                                                            <span class="help-block">الرجاء اختيار نوع المطبوع الدوري  </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="pubCity" id="langID" runat="server" class="form-control" required="required">
                                                            </select>
                                                            <span class="help-block">الرجاء اختيار  لغة النص  </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="pubCity" id="freqID" runat="server" class="form-control" required="required"></select>
                                                            <span class="help-block">الرجاء اختيار  تكرار الصدور  </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="  col-md-1">
                                                            <input id="txtFristIssueDate" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtStopDate" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtpreviousTitle" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtSubject" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                    </div>
                                                    <div id="filesUpload">
                                                        <div class="form-group">
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    <h3 class="block">ادخل بيانات الناشر</h3>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                            هاتف
                                                        </label>
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepPhone" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepFax" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepPost" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <input id="txtDepZip" runat="server" type="text" class="form-control" maxlength="255"/>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtDepNID" runat="server" type="text" class="form-control" name="card_number" required="required" maxlength="255"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtDepName" runat="server" type="text" placeholder="" class="form-control" required="required" maxlength="255"/>
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input id="txtDepEmail" runat="server" type="email" placeholder="" class="form-control" required="required" maxlength="255"/>
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
													<div class="form-group">
                                                        <label class="control-label col-md-3">
                                                            رابط الموقع الالكتروني لمقدم الطلب
                                                                <span class="required">* </span>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <input id="txtDepURL" runat="server" type="text" placeholder="" class="form-control" required="required" maxlength="255"/>
                                                            <span class="help-block"></span>
